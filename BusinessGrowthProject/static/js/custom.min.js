! function () {
    ...
    var t = function () {
        ...
        s = function (e) {
            for (var t = function (e) {
                    for (var t, o, a, n, r = e.childNodes, i = r.length, s = [], l = 0; l < i; l++) 1 === (t = r[l]).nodeType && (o = t.children[0], console.log(t), a = o.getAttribute("data-size").split("x"), n = {
                        src: o.getAttribute("href"),
                        w: parseInt(a[0], 10),
                        h: parseInt(a[1], 10)
                    }, t.children.length > 1 && (n.title = t.children[1].innerHTML), o.children.length > 0 && (n.msrc = o.children[0].getAttribute("src")), n.el = t, s.push(n));
                    return s
                }, o = function e(t, o) {
                    return t && (o(t) ? t : e(t.parentNode, o))
                }, a = function (e, o, a, n) {
                    var r, i, s = document.querySelectorAll(".pswp")[0];
                    if (i = t(o), r = {
                    ...
                    isNaN(r.index) || (a && (r.showAnimationDuration = 0), new PhotoSwipe(s, PhotoSwipeUI_Default, i, r).init())
                }, n = document.querySelectorAll(e), r = 0, i = n.length; r < i; r++) n[r].setAttribute("data-pswp-uid", r + 1), n[r].onclick = function (e) {
                ...
                if (n) {
                    for (var r, i = n.parentNode, s = n.parentNode.childNodes, l = s.length, d = 0, u = 0; u < l; u++)
                        if (1 === s[u].nodeType) {
                            if (s[u] === n) {
                                r = d;
                                break
            ...
            s.pid && s.gid && a(s.pid, n[s.gid - 1], !0, !0)
        },
        l = function () {
    ...
    jQuery(function () {
        t(), n(), r(), i(), $(".probootstrap-gallery").length > 0 && s(".probootstrap-gallery"), l()
